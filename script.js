...
document.querySelectorAll('.feature-card, .showcase-card, .download-card').forEach(el => {
    el.style.opacity = '0';
...
const watchDownloadBtn = document.getElementById('watch-download');
...
// Smartwatch App Download
watchDownloadBtn.addEventListener('click', (e) => {
    e.preventDefault();
